        ...
        return (
            <div>
                ...
                <div className="bg-white p-12 rounded-lg shadow-md text-center">
                    ...
                    <p className="text-gray-600 text-lg">Nenhuma venda parcelada encontrada</p>
                    <p className="text-gray-400 mt-2">As vendas com pagamento "Parcelado" aparecerão aqui</p>
                </div>
            </div>
        );
    }
